...
function ApprovalsPage({user,products,items,onCreate,onSubmit,onDecision}:{user:User;products:Product[];items:Experiment[];onCreate:(body:ExperimentDraft)=>Promise<void>;onSubmit:(id:number)=>Promise<void>;onDecision:(id:number,d:'approved'|'rejected')=>Promise<void>}) {
